                        ...
                        <div class="hidden" id="registry">
                            ...
                            <div class="row 50%">
                                <div class="6u 12u(mobile)">
                                    ...
                                    <input class="grouprequired" name="patRegistryMetricDiagnoses" id="patRegistryMetricDiagnoses" type="text"  disabled /> 
                                ...
                                <div class="6u 12u(mobile)">
                                    ...
                                    <input class="grouprequired" name="patRegistryMetricMeds" id="patRegistryMetricMeds" type="text" disabled />
                                </div>
                            </div>
                            <div class="row 50%">
				<div class="6u 12u(mobile)">
                                    <label for="patRegistryMetricLabs">Labs:</label>
                                    <input class="grouprequired" name="patRegistryMetricLabs" id="patRegistryMetricLabs" type="text" disabled />
				</div>
				<div class="6u 12u(mobile)">
                                    <label for="patRegistryMetricMeasures">Measures:</label>
                                    <input class="grouprequired" name="patRegistryMetricMeasures" id="patRegistryMetricMeasures" type="text" disabled />
				</div>
                            </div>
                            <div class="row 50%">
                                <div class="6u 12u(mobile)">
                                    <label for="patRegistryMetricOther">Other:</label>
                                    <input class="grouprequired" name="patRegistryOtherMetric" id="patRegistryOtherMetric" type="text" disabled />
				</div>
                            </div>
                            <br />
                        </div> 
